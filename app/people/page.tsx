...
export default function PeoplePage() {
  return <><section className="page-hero page-width"><p className="section-label">People</p><h1>Meet the group.</h1><p>We are building a collaborative team around mobile systems, wearable sensing, and human-centered computing.</p></section>
    <section className="people-page page-width"><article className="director-card"><div className="director-photo"><img src={`${basePath}/yang-liu.jpg`} alt="Yang Liu" /></div><div className="director-info"><p className="section-label">Principal Investigator</p><h2>Yang Liu</h2><p className="role">Assistant Professor · Department of Computer Science<br />Florida State University</p><p>Yang&apos;s research sits at the intersection of wearable sensing, mobile computing, and artificial intelligence. Before joining FSU, he was a Senior Research Associate and Affiliated Lecturer at the University of Cambridge.</p><div className="profile-links"><a href="https://yangliu-cs.github.io/" target="_blank" rel="noreferrer">Personal website ↗</a><a href="https://scholar.google.com.sg/citations?hl=en&amp;user=prIwSokAAAAJ" target="_blank" rel="noreferrer">Google Scholar ↗</a><a href="mailto:yl25r@fsu.edu">Email ↗</a></div></div></article>
      <section className="students-section"><div className="section-top"><div><p className="section-label">Students</p><h2>PhD students</h2></div></div><div className="student-grid"><a className="student-card" href="https://nancy-gaoo.github.io/" target="_blank" rel="noreferrer"><div className="student-photo"><img src={`${basePath}/people/linlu-gao.jpg`} alt="Linlu Nancy Gao" /></div><div><p>PhD Student</p><h3>Linlu (Nancy) Gao</h3><span>Mobile health · HCI · Ubiquitous computing</span><b>Personal website ↗</b></div></a></div><div className="student-lists"><section><h3>Master&apos;s students</h3><ul><li>Ryan Nageer</li></ul></section><section><h3>Undergraduate students</h3><ul><li>Filip Kaczmarczyk</li><li>Nikki Zahedi</li><li>Juan Pablo Pastrana</li><li>Katelyna Pastrana</li><li>Mohammad Rubayet Islam</li></ul></section></div></section>
